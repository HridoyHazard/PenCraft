...
import { useGetArticleByAuthorIdQuery } from "../slices/articleApiSlice";
...
const AuthorProfile = () => {
  ...
  const { data: articles, isLoading: isLoadingArticles } =
    useGetArticleByAuthorIdQuery(userId);
        ...
        <>
          <div class="max-w-7xl mx-auto my-8 px-2">
            <div class="flex justify-center text-2xl md:text-3xl font-bold">
              <div class="relative w-full max-w-2xl my-8 md:my-16 flex flex-col items-start space-y-4 sm:flex-row sm:space-y-0 sm:space-x-6 px-4 py-8 border-2 border-dashed border-gray-400 dark:border-gray-400 shadow-lg rounded-lg">
                ...
                <div class="w-full flex justify-center sm:justify-start sm:w-auto">
                  <img
                    class="object-cover h-72 mt-3 mr-3 rounded-md"
                    src={data.avatar}
                  />
                </div>

                <div class="w-full sm:w-auto flex flex-col items-center sm:items-start">
                  <p class="font-display mb-2 text-2xl font-semibold text-black">
                    {data.name}
                  </p>
                  ...
                  <div class="pt-8 pb-2">
                    <button class="bg-green-700 hover:bg-green-900 text-white font-bold py-1 px-4 rounded-full">
                      Get In Touch
                    </button>
                  </div>
            ...
            <h1 class="text-center text-[32px] font-bold">Author Works</h1>
            <div class="grid gap-5 md:grid-cols-2 lg:grid-cols-3 p-2 xl:p-5 overflow-hidden">
